...
while true; do
    ...
    echo "14. Network Monitoring"
    echo "15. Alert & Incident Management"
    echo "16. Service Dependency Monitoring"
    echo "17. Dashboard"
    echo "18. Exit"
    echo
    ...
    case "$choice" in
        ...
        14)
            ./modules/network_monitoring.sh
            ;;

        15)
            ./modules/alert_management.sh
            ;;

        16)
            ./modules/dependency_monitoring.sh
            ;;
